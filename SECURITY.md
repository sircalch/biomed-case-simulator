...
BioMed Case Simulator is an educational platform. Do not commit production secrets, API keys, database credentials, or private environment values to this repository.

## Secrets

- Keep `SUPABASE_SERVICE_ROLE_KEY` and any future private API keys only in server-side environment variables.
